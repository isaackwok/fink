...
void main() {
  ...
  group('EmotionsSelectorButton', () {
    group('empty state', () {
      ...
      testWidgets('shows Select Emotions and plus icon when empty', (
        tester,
      ) async {
        await tester.pumpWidget(buildSubject());
        expect(find.text('Select Emotions'), findsOneWidget);
    ...
    group('text formatting', () {
      testWidgets('single emotion shows "You felt X by this movie."', (
        ...
        await tester.pumpWidget(
          buildSubject(emotions: [emotionList[EmotionType.joyful]!]),
        );
    ...
    group('typography', () {
      ...
      testWidgets('emotion name renders in AvenirNext at w600', (tester) async {
        await tester.pumpWidget(
          buildSubject(emotions: [emotionList[EmotionType.joyful]!]),
        );
    ...
    group('selected state', () {
      testWidgets('shows edit icon when emotions are selected', (tester) async {
        await tester.pumpWidget(
          buildSubject(emotions: [emotionList[EmotionType.joyful]!]),
        );
    ...
    group('energy-based gradient', () {
      ...
      testWidgets('Perspectives-only emotions produce neutral gradient', (
        tester,
      ) async {
        await tester.pumpWidget(
          buildSubject(
            emotions: [
              emotionList[EmotionType.ironic]!,
              emotionList[EmotionType.thoughtProvoking]!,
            ],
          ),
        );
        ...
        final gradientContainers =
            tester
                ...
                .toList();
        final gradient =
            (gradientContainers.first.decoration as BoxDecoration).gradient
                as LinearGradient;

        expect(gradient.colors, const [Color(0xFFDDDDDD), Color(0xFFDDDDDD)]);
      });
    });
